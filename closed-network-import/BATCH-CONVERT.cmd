...
REM 폐쇄망 batch 변환 entrypoint(Slice 99F). exact-JDK 게이트/compile/regression 로직을 여기서
REM 재구현하지 않고 verify-standalone.bat에 전부 위임한다(중복/우회 없음, 그 게이트를 통과하지
REM 못하면 변환을 시작하지 않는다).
